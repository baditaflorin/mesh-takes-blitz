...
**Live → https://baditaflorin.github.io/mesh-takes-blitz/**

**Source → https://github.com/baditaflorin/mesh-takes-blitz**
...
git clone https://github.com/baditaflorin/mesh-takes-blitz
cd mesh-takes-blitz
npm install
npm run dev
```
...
- `mesh-takes-blitz:signalingUrl`
- `mesh-takes-blitz:turnTokenUrl`
- `mesh-takes-blitz:iceServers`
- `mesh-takes-blitz:room`
